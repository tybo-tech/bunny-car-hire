...
import { PARENT_CATEGORIES, PRODUCT_ORDER_LIMIT_MAX, PRODUCT_TYPE_JIT, PRODUCT_TYPE_STOCK, STATUS_ACTIIVE_STRING, STATUS_TRASHED_STRING } from 'src/shared/constants';
...
export class ProductListCardsComponent implements OnInit {
  ...
  addProduct() {
    ...
    this.newProduct = {
      ...
      ParentCategoryId: 0,
      CategoryName: '',
      ParentCategoryName: PARENT_CATEGORIES[0].Name,
      ParentCategoryGuid: PARENT_CATEGORIES[0].Id,
      CategoryGuid: '',
