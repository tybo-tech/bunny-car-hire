...
import { SignInFormComponent } from 'src/app/account/sign-in/sign-in-form/sign-in-form.component';
import { SignUpFormComponent } from 'src/app/account/sign-in/sign-up-form/sign-up-form.component';
...
import { DriverDetailsComponent } from 'src/app/driver/driver-details/driver-details.component';
import { FileUploaderComponent } from 'src/app/driver/file-uploader/file-uploader.component';
...
import { AddressWidgetComponent } from 'src/shared/components/address-widget/address-widget.component';
import { MyOrdersComponent } from '../dashboard/orders/my-orders/my-orders.component';
import { TrackOrderComponent } from '../dashboard/orders/view-order/view-my-order/track-order/track-order.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'home/booking-succesful/:id', component: ShopingSuccesfulComponent },
      ...
      { path: 'home/track', component: TrackOrderComponent },
      { path: 'home/track/:id', component: TrackOrderComponent },
      ...
      {path:'cars', component: ProductSectionComponent},
